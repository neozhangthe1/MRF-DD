...
namespace MRF_DD {
    ...
    int FactorAtMostOne::SolveMAP(const vector<double> &variable_log_potentials,
    ...
    void FactorAtMostOne::SolveQP(const vector)(const vector<double> &variable_log_potentials,
                                                const vector<double> &additional_log_potentials,
                                                vector<double> *variable_posteriors,
                                                vector<double> *additional_posteriors) {
